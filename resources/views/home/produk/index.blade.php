            ...
            <div class="row g-0 gx-5 align-items-end">
                <div class="col-lg-6">
                    <div class="section-header text-start mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                        <h1 class="display-5 mb-3 mt-5">Produk Diskon</h1>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                                <div class="product-item">
                                    ...
                                    <div class="text-center p-4">
                                        <a class="d-block h5 mb-2 text-uppercase" href="">{!! Str::limit($item->nama_produk, 40) !!}</a>
                                        <span class="text-primary me-1">{{ formatRupiah($item->harga_produk) }}</span>
                                        {{-- <span
                                        class="text-body text-decoration-line-through">{{ formatRupiah($item->harga_produk) }}</span> --}}
                                    </div>
                                    <div class="d-flex border-top">
                                        <small class="w-50 text-center border-end py-2">
                                            <a class="text-body" href="/produk/{{ $item->id }}"><i
