  ...
  @section('content')
      ...
      <head>
          ...
          <style>
              ...
              /* Gaya untuk postingan terbaru */
              .recent-post {
                  height: 100%;
                  /* Mengatur tinggi postingan terbaru agar seragam */
              }

              /* Gaya untuk gambar di dalam postingan terbaru */
              .recent-post img {
                  height: 100%;
                  /* Mengatur tinggi gambar agar mengisi tinggi postingan terbaru */
                  object-fit: cover;
          ...
          <main class="container">
              {{-- <div class="p-4 p-md-5 mb-4 rounded text-body-emphasis bg-body-secondary">
                  <div class="col-lg-6 px-0">
                      ...
                      <p class="lead mb-0"><a href="#" class="text-body-emphasis fw-bold">Continue reading...</a>
                      </p>
                  </div>
              </div> --}}
              ...
              <div class="row g-5 mt-4">
                  <div class="col-md-8">
                      ...
                      <p class="blog-post-meta">{{ $blog->created_at->format('d F Y ') }}
                      </p>
                      <img loading="lazy" alt="img" src="/{{ $blog->gambar }} " width="100%" height="400">
                      <article class="blog-post">
                          {{-- <h2 class="display-5 link-body-emphasis mb-1 mt-2"> {{ $blog->judul }}
                          </h2> --}}
                          {{-- <p class="blog-post-meta">{{ $blog->created_at->format('d F Y ') }}
                          </p> --}}
                          <p class="mt-5">{!! $blog->deskripsi !!}</p>
                  ...
                  <div class="col-md-4">
                      <div class="position-sticky" style="top: 2rem;">
                          <div class="p-4 mb-3 bg-body-tertiary rounded">
                              <h4 class="fst-italic">Informasi</h4>
                              <p class="mb-0">Ini dia berita terkini! Perusahaan kami telah merilis koleksi terbaru
                                  furnitur yang menghadirkan desain
                                  inovatif dan tren terkini. Jelajahi pilihan terbaru kami yang menggabungkan
                                  fungsionalitas, gaya, dan
                                  ...
                                  @foreach ($recentBlogs as $recentBlog)
                                      <li>
                                          <a class="d-flex flex-column flex-lg-row gap-3 align-items-start align-items-lg-center py-3 link-body-emphasis text-decoration-none border-top"
                                              href="#">
                                              <img loading="lazy" alt="img" src="/{{ $recentBlog->gambar }}"
                                                  width="50%" height="96">
                                              <div class="col-lg-8">
                                                  <h6 class="mb-0">{{ $recentBlog->judul }}</h6>
                                                  <small
                                                      class="text-body-secondary">{{ $recentBlog->created_at->format('d F Y ') }}</small>
                                              </div>
                                          </a>
                                      </li>
                                  @endforeach
